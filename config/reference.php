 ...
 *     default?: scalar|null, // Default notification library (e.g., "flasher", "toastr", "noty", "notyf", "sweetalert") // Default: "flasher"
 *     main_script?: scalar|null, // Path to the main PHPFlasher JavaScript file // Default: "/vendor/flasher/flasher.min.js"
 *     inject_assets?: bool, // Automatically inject assets into HTML pages // Default: true
 *     translate?: bool, // Enable message translation // Default: true
 *     excluded_paths?: list<scalar|null>,
 *     filter?: list<mixed>,
 *     scripts?: list<scalar|null>,
 *     styles?: list<scalar|null>,
 *     options?: list<mixed>,
 *     flash_bag?: mixed, // Map Symfony flash messages to notification types // Default: true
 *     presets?: array<string, array{ // Default: []
 *         type?: scalar|null, // Notification type (e.g., "success", "error")
 *         title?: scalar|null, // Default title
 *         message?: scalar|null, // Default message
 *         options?: list<mixed>,
 *     }>,
 *     plugins?: array<string, array{ // Default: []
 *         view?: scalar|null, // Custom twig view template
 *         styles?: list<scalar|null>,
 *         scripts?: list<scalar|null>,
 *         options?: list<mixed>,
 *     }>,
